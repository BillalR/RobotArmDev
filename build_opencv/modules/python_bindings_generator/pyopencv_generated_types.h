...
CVPY_TYPE(sfm_libmv_CameraIntrinsicsOptions, cv::sfm::libmv_CameraIntrinsicsOptions, libmv_CameraIntrinsicsOptions, NoBase, pyopencv_cv_sfm_sfm_libmv_CameraIntrinsicsOptions_libmv_CameraIntrinsicsOptions);
CVPY_TYPE(sfm_libmv_ReconstructionOptions, cv::sfm::libmv_ReconstructionOptions, libmv_ReconstructionOptions, NoBase, pyopencv_cv_sfm_sfm_libmv_ReconstructionOptions_libmv_ReconstructionOptions);
CVPY_TYPE(sfm_BaseSFM, Ptr<cv::sfm::BaseSFM>, Ptr, NoBase, 0);
CVPY_TYPE(sfm_SFMLibmvEuclideanReconstruction, Ptr<cv::sfm::SFMLibmvEuclideanReconstruction>, Ptr, sfm_BaseSFM, 0);
