...
#include "/Users/billalrahimi/Desktop/Robotics/C_Template/opencv/../opencv_contrib/modules/text/include/opencv2/text/swt_text_detection.hpp"
#include "/Users/billalrahimi/Desktop/Robotics/C_Template/opencv/../opencv_contrib/modules/text/include/opencv2/text/erfilter.hpp"
#include "/Users/billalrahimi/Desktop/Robotics/C_Template/opencv/../opencv_contrib/modules/text/include/opencv2/text/ocr.hpp"
#include "/Users/billalrahimi/Desktop/Robotics/C_Template/opencv/../opencv_contrib/modules/text/include/opencv2/text/textDetector.hpp"
...
JNIEXPORT jlong JNICALL Java_org_opencv_text_Text_createERFilterNM1_11 (JNIEnv*, jclass, jstring, jint, jfloat, jfloat, jfloat, jboolean);
...
JNIEXPORT jlong JNICALL Java_org_opencv_text_Text_createERFilterNM1_12 (JNIEnv*, jclass, jstring, jint, jfloat, jfloat, jfloat);
...
JNIEXPORT jlong JNICALL Java_org_opencv_text_Text_createERFilterNM1_13 (JNIEnv*, jclass, jstring, jint, jfloat, jfloat);
...
JNIEXPORT jlong JNICALL Java_org_opencv_text_Text_createERFilterNM1_14 (JNIEnv*, jclass, jstring, jint, jfloat);
...
JNIEXPORT jlong JNICALL Java_org_opencv_text_Text_createERFilterNM1_15 (JNIEnv*, jclass, jstring, jint);
...
JNIEXPORT jlong JNICALL Java_org_opencv_text_Text_createERFilterNM1_16 (JNIEnv*, jclass, jstring);
...
JNIEXPORT void JNICALL Java_org_opencv_text_Text_detectRegions_11 (JNIEnv*, jclass, jlong, jlong, jlong, jlong, jint, jstring);
...
JNIEXPORT void JNICALL Java_org_opencv_text_Text_detectRegions_12 (JNIEnv*, jclass, jlong, jlong, jlong, jlong, jint);
...
JNIEXPORT void JNICALL Java_org_opencv_text_Text_detectRegions_13 (JNIEnv*, jclass, jlong, jlong, jlong, jlong);
...
//
// static Ptr_OCRBeamSearchDecoder cv::text::OCRBeamSearchDecoder::create(String filename, String vocabulary, Mat transition_probabilities_table, Mat emission_probabilities_table, int mode = OCR_DECODER_VITERBI, int beam_size = 500)
//
...
JNIEXPORT jlong JNICALL Java_org_opencv_text_OCRBeamSearchDecoder_create_11 (JNIEnv*, jclass, jstring, jstring, jlong, jlong, jint);
  ...
  (JNIEnv* env, jclass , jstring filename, jstring vocabulary, jlong transition_probabilities_table_nativeObj, jlong emission_probabilities_table_nativeObj, jint mode)
{
    ...
    try {
        ...
        Mat& transition_probabilities_table = *((Mat*)transition_probabilities_table_nativeObj);
        Mat& emission_probabilities_table = *((Mat*)emission_probabilities_table_nativeObj);
        Ptr_OCRBeamSearchDecoder _retval_ = cv::text::OCRBeamSearchDecoder::create( n_filename, n_vocabulary, transition_probabilities_table, emission_probabilities_table, (int)mode );
        return (jlong)(new Ptr_OCRBeamSearchDecoder(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT jlong JNICALL Java_org_opencv_text_OCRBeamSearchDecoder_create_12 (JNIEnv*, jclass, jstring, jstring, jlong, jlong);
...
JNIEXPORT jlong JNICALL Java_org_opencv_text_OCRHMMDecoder_create_11 (JNIEnv*, jclass, jstring, jstring, jlong, jlong, jint);
...
JNIEXPORT jlong JNICALL Java_org_opencv_text_OCRHMMDecoder_create_12 (JNIEnv*, jclass, jstring, jstring, jlong, jlong);
