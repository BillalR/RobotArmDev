...
#include "/Users/billalrahimi/Desktop/Robotics/C_Template/opencv/../opencv_contrib/modules/tracking/include/opencv2/tracking/feature.hpp"
#include "/Users/billalrahimi/Desktop/Robotics/C_Template/opencv/../opencv_contrib/modules/tracking/include/opencv2/tracking/tracker.hpp"
  ...
  (JNIEnv* env, jclass )
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::MultiTracker> _retval_ = makePtr<cv::MultiTracker>();
        return (jlong)(new Ptr<cv::MultiTracker>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
  ...
  (JNIEnv* env, jclass , jlong self, jlong newTracker_nativeObj, jlong image_nativeObj, jdouble boundingBox_x, jdouble boundingBox_y, jdouble boundingBox_width, jdouble boundingBox_height)
{
    ...
    try {
        ...
        Mat& image = *((Mat*)image_nativeObj);
        Rect boundingBox(boundingBox_x, boundingBox_y, boundingBox_width, boundingBox_height);
        return (*me)->add( *((Ptr<cv::Tracker>*)newTracker_nativeObj), image, boundingBox );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
...
JNIEXPORT jlong JNICALL Java_org_opencv_tracking_TrackerCSRT_create_10 (JNIEnv*, jclass);
